...
import { MechanismToggles } from "./MechanismToggles";
    ...
    <CinematicSection id="hero" className="sm:mt-0 mt-16 pb-0">
      ...
      <div className={`w-full flex ${isBento ? 'flex-col text-center' : 'flex-col md:flex-row'} items-center justify-between h-full relative z-10 gap-10`}>
        ...
        <motion.div
          ...
          className={`w-full ${isBento ? 'w-full flex justify-center items-end h-[40vh]' : 'md:w-1/2 flex justify-center md:justify-end items-end h-[50vh] md:h-[80vh]'} relative pt-10`}
        >
          <img
            src={toSrc(shaq)}
            alt="Randall Murphy"
